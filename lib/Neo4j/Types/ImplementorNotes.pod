...
See L<Neo4j::Types::DateTime> for the methods defined by that role.
...
The remaining methods C<epoch()> and C<type()> may be inherited
from the role. But you may also override them as required.
...
See L<Neo4j::Types::Duration> for the methods defined by that role.
